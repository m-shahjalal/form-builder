...
const CreateForm = () => {
	return (
		<div class='p-8 rounded border border-gray-200 container mx-auto max-w-5xl'>
			...
			<form>
				...
				<div class='space-x-4 mt-8'>
					<button
						type='submit'
						class='py-2 px-4 bg-primary text-white rounded hover:bg-blue-600 active:bg-blue-700 disabled:opacity-50'>
						Save
					</button>
